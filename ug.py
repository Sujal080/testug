        ...
        for i, part in enumerate(filename, 1):
            ...
            if thumb in ["/d", "no"] or not os.path.exists(thumb):
                ...
                if os.path.exists(temp_thumb):
                    ...
                    text_cmd = f'ffmpeg -i "{temp_thumb}" -vf "drawtext=text=\'{spaced_text}\':fontsize=90:fontcolor=white:borderw=5:bordercolor=black:x=(w-text_w)/2:y=60" -c:v mjpeg -q:v 2 -y "{temp_thumb}"'
